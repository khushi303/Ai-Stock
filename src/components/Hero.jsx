    ...
    return (
        <div className='bg-heroAiStock bg-cover bg-center bg-repeat relative sm:pb-[58px] pb-10'>
            <div className='pt-12 container xl:max-w-[1176px] relative z-20'>
                <h1 className='md:text-custom-xxl sm:text-4xl text-custom-3xl font-bold !leading-[120%] text-center text-white max-w-[958px] mx-auto'>Dive into the Explosive Momentum of 2024 with the <span className='bg-clip-text text-transparent bg-gradient-to-br from-[#00FFE1] to-[#6E5DF6]'>Top 7</span> Fastest-Growing <span className='bg-clip-text text-transparent bg-gradient-to-b from-[#00FFE1] to-[#6E5DF6]'>AI Stocks!</span></h1>
